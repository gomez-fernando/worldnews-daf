...
@section('title')
    <title>Editar artículo en revisión para republicar</title>
@endsection
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        Editar artículo en revisión para republicar
                    </div>
                    <div class="card-body">
                        <form action="{{ route('inReviewPublished.update') }}" method="POST" id="" enctype="multipart/form-data">
                            @csrf
