...
CREATE TABLE IF NOT EXISTS `articles` (
                                          ...
                                          `state` enum('en proceso','en revisión','publicado','inactivo') NOT NULL,
...
--
-- Estructura de tabla para la tabla `in_review_published`
--

DROP TABLE IF EXISTS `in_review_published`;
CREATE TABLE IF NOT EXISTS `in_review_published` (
                                                  ...
                                                  `created_at` datetime NOT NULL,
                                                  `updated_at` datetime DEFAULT NULL,
                                                  CONSTRAINT pk_in_review_published PRIMARY KEY(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
